...
window.layer = {
    ...
    config: function(options, fn){
        ...
        layer.use('layer.css'.replace('/modules/layer/',''), (options.extend && options.extend.length > 0) ? (function loop(){
...
'function' === typeof define == false ? define(function(){
    ready.run();
    return layer;
}) : function(){
   ready.run();
   ...
   layer.use('layer.css'.replace('/modules/layer/',''));
}();
